...
configurable_parameters = [
    ...
    {'name': 'rgb_camera.power_line_frequency', 'default': '1', 'description': '0-Disabled, 1-50Hz, 2-60Hz (USA only)'},
    {'name': 'depth_module.profile',            'default': '640,480,30', 'description': 'depth module profile (WIDTH x HEIGHT x FPS)'},
    {'name': 'rgb_camera.profile',              'default': '640,480,30', 'description': 'color image width (WIDTH x HEIGHT x FPS)'},
    ...
    {'name': 'pose_fps',                        'default': '15', 'description': "''"},
